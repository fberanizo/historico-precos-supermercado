...
export function fetchProducts() {
  return Promise.resolve({data: [
    ...
    {regex: '(ACHOC APTI 400g|ACHOC PO TODDY 400G|ACHOC PO ITALAC SCH 400G|ACHOC PO TODDY 400G|ACHOC TODDY 400G|TODDY TRAD.400g)', text: 'Achocolatado'},
    {regex: '(ACEM KG|CARNE ACEM MOIDO)', text: 'Acém' },
    {regex: '(ADOC LIQ ZERO CAL SACA 200ml|ADOC ZERO CAL SACARI|ADOC.ZERO-CAL 200ML|ADOC LIQ ZERO CAL 100ML|ADOC.ZERO-CAL 100ML|ADOCANTE ZERO CAL LI|ADOC ZERO CAL SACARI)', text: 'Adoçante'},
    ...
    {regex: '(AZEIT EX VIRG BARCELONA 500ml|AZEITE MORIXE 500ML|AZEITE PURO GALLO VD 500ML|AZ.OLIV.CONDE 500ML|AZEITE COCINERO 500M|AZEITE EX VIRGEM FAMIGLIA DORO VD 500ML|AZEITE EX VIRGEM LA ESPANOLA VD 500ML|AZEITE BALTICO CLASS)', text: 'Azeite'},
    ...
    {regex: '(ACUCAR REFI CARAVELAS 1KG|ACUCAR REF.CARAVELAS|UNIAO 1KG REFINADO C|ACUCAR CRISTAL CARAVELAS 1KG|ACUCAR BIG BOM EXTRA|ACUCAR REF CARAVELAS 1KG|ACUCAR REF.CARAVELAS|ACUCAR A ALEGRE 1KG|ACUCAR CARAVELAS 1KG)', text: 'Açúcar Refinado 1kg'},
    {regex: '(BACALHAU LING 8 10)', text: 'Bacalhau' },
    {regex: '(BACON DEF AURORA kg FRAC|BACON SANTA ROSA PED|BACON SEARA KG|BACON MANTA SADIA KG|BACON MANTA SADIA KG|BACON SANTA ROSA PED|BACON SADIA|BACON SOFT PIG PED)', text: 'Bacon'},
    ...
    {regex: '(BOMBOM LACTA FAVORITOS 250.6G|BOMBOM LACTA 220G|B.BOM GAROTO 250G|BOMBOM NESTLE ESPECIALIDADES 300G|BOMBOM LACTA 289.2G|BOMBOM NESTLE 300G E|BOMBOM NESTLE ESPECIALIDADES 300G|BOMBOM GAROTO 250G S|BOMBOM GAROTO 300G S|BOMBOM LACTA 250 6G|BOMBOM NESTLE 251G E)', text: 'Caixa de Bombons'},
    ...
    {regex: '(COCO RAL MENINA PC 100g|COCO PREFERIDA 50g|COCO RALADO SOCOCO 1|COCO RALADO MENINA 5|COCO FLOCOS MENINA10|COCO PREFERIDA 100g|COCO RALADO MENINA 1)', text: 'Coco Ralado'},
    ...
    {regex: '(MISTURA CREME MOCOCA TP 200G|CR LEITE PIRACANJUBA|CR LEIT/E SHEFA TP 20|CR DE LEITE ITALAC TP 200G|CR LEITE SHEFA TP 20|CR.LEITE JUSSARA TP|CR.LEITE SHEFA 200g|CREME LEITE JUSSARA)', text: 'Creme de Leite'},
    ...
    {regex: '(ESC DENTAL GREEN ENJOY|ESCOVA SORRISO ORIGI|ESC.TEK MED.|ESC DENT COLGATE ESSENCIAL CLEAN MACIA|ESC DENT J J REACH ULTRA CLEAN GRANDE|ESC DENT J J TEK|ESCOVA ORAL B INDICA|ESC.REACH.U.CLEAN MD|ESC DENT J J TEK DU|ESC DENT SORRISO TRI)', text: 'Escova de Dentes'},
    ...
    {regex: '(EXT TOMATE ELEFANTE PTE 310G|EXT.TOM.ELEFANTE 310G|EXT TOM ELEFANTE 340G|EXT.TOM.LAT.ELE.340g|EXTRATO ELEFANTE LT|EXTRATO ELEFANTE PET|EXTRATO ELEFANTE 340)', text: 'Extrato de Tomate'},
    {regex: '(FAR MILHO HIKARI 500g|FAR.MILHO DEUSA 500G|FARINHA MILHO AMARELA YOKI 500G|FARINHA S ANTONIO MI)', text: 'Farinha de Milho'},
    {regex: '(FAR TRIG TRAD BUQUE 1KG|FAR.TRIGO RENATA 1KG|TRIGO NONITA 1KG|FAR.TRIGO T.OFELIA 1|FARINHA TRIGO RENATA|FARINHA CLARICE 1KG|FARINHA DE TRIGO LILI 1KG|FARINHA DE TRIGO SANTA CLARA 1KG|FARINHA TRIGO BIG BO|FARINHA VEGA 1KG)', text: 'Farinha de Trigo'},
    {regex: '(FAR ML HIKARI 400G|FAROFA MAND HIKARI 5|FAROFA MONJOLINHO|FAROFA PRONTA MAND YOKI 500G|FAROFA YOKI 500G|FAROFA MANDIOCA YOKI)', text: 'Farofa'},
    ...
    {regex: '(FEIJAO PRETO CALDO NOBRE 1KG|FEIJAO SANJER PRETO|FEIJAO BIJU 1KG PRET|FEIJ.PRETO CAMIL 1KG|FEIJAO CABRERA PRETO)', text: 'Feijão Preto'},
    ...
    {regex: '(LEITE COND CAMPOS TP 395G|COND.TRIANGULO TP|LEITE COND CAMPOS JO|LEITE CONDENS PIRACA|LEITE CONDENS TIROL|LEITE COND NILZA 395G|LEITE COND ITALAC TP 395G|LEITE CONDENS FRIMES|LEITE CONDENS JUSSAR)', text: 'Leite Condensado'},
    ...
    {regex: '(LIMP UAU 500ml LAVANDA|LIMP.UAU LV.1L PG.800ML|LIMP AZULIM M USO 50|LIMP UAU M USO 500ML|LIMP UAU MULTIUSO 50|LIMPADOR UAU MULTI U|LIMP ZAP CLEAN M USO LARANJA 500ML|LIMP UAU M USO 10 G|LIMP UAU MULTI USO LAVANDA 500ML|LIMP.M.USO.UAU LAV)', text: 'Limpador UAU'},
    {regex: '(LING CAL AURORA kg FRAC|CALABRESA SOFT PIG|CALABRESA SANTA ROSA|LING.CAL.SADIA KG|LING SEARA CALABRESA|CALABRESA SANTA ROSA|LING.CAL.PERDIGAO KG|LINGUICA CALABRESA SADIA KG|CALABRESA PERDIGAO D)', text: 'Linguiça Calabresa'},
    {regex: '(LINGUICA SUINA NOBRE 1kg|LING.TOSC.SEARA KG|LING.TOSC.AURORA KG|LING CARNE SUINA CONG NOBRE 1KG|LING MARCHIORI FRANG|LING NOBRE SUINA MIS|LING TOSCANA BIGBOM)', text: 'Linguiça Crua'},
    ...
    {regex: '(MAC FLOR DE LIS 500G PARAFUSO|MAC SEMOLA GALO PARAFUSO 2 500G|MAC SEMOLADO BASILAR|MAC.SEM.GALO 500G|MAC.SEMOL.BASILAR|MACARRAO BASILAR SEM|S AMALIA SEMOLA 500G|MACARRAO GALO SEMOLA|MAC GALO SEMOLADO 50|MAC BARILLA 500G ESP|MAC S AMALIA OVOS 50|MAC STA AMALIA SEMOL)', text: 'Macarrão Parafuso'},
    ...
    {regex: '(CREME VEG BECEL 500G CSAL|MARG BECEL 500G|BECEL 250G|BECEL 500G|BECEL 500G MANTEIGA|CR VEGETAL PRIME 500|CR.VEG.BECEL 500G|CREME VEGETAL CSAL TRAD BECEL 500G|MARG CLAYBOM 500G|CR VEGETAL BECEL 500|MARGARINA BECEL 500G|MARGARINA DELICIA 50)', text: 'Margarina'},
    ...
    {regex: '(MOL TOM QUERO 340G|MOLHO OLE SACHE 300G|MOLHO STELLA D ORO 3|MOLHO TRAD.PRED.340g|MOLHO FUGINI SACHE 3|MOLHO TOM TRAD REFOG PREDILECTA SCH 340G|MOLHO TOM TRAD PRIMOR SACHE 340G|MOLHO TRAD.PRED.340g|MOLHO VAL SACHE 340G|MOLHO CEPERA SACHE 3)', text: 'Molho de Tomate'},
    {regex: '(FT MORANGO 250G)', text: 'Morango' },
    {regex: '(OLEO SOJA VITALIV 900ML|OLEO VITALIV PET 900|OLEO COAMO PET 900ML|OLEO CONCORDIA PET 9|OLEO SOYA PET 900ML|OLEO SOJA SOYA PVC 9|OLEO COCAMAR PET 900|OLEO LEVE PET 900ML|OLEO SOJA CONCORDIA 900ML|OLEO SOJA SOYA 900ML|OLEO SOJA SUAVIT|OLEO SOJA V.VELHA)', text: 'Óleo de Soja'},
    ...
    {regex: '(PAPEL HIG NEVE NEU 30M L12P11|PAPEL HIG NEVE LV12|PAPEL HIGIENICO NEV|PAPEL HIG NEVE FD L12P11UN 30M|P HIG SUBLIME C 8UN|PAP.H.NEVE L12 P11|PAPEL HIG NEVE LV12|PAPEL HIG NEVE LV16|PAPEL HIG PERSONAL FS 4UN 30M)', text: 'Papel Higiênico'},
    {regex: '(CR DENT COLGATE NAT EXTRA 90g|CR DENTAL ORAL B 70G|CR DENT COLGATE 90G|CR.COLG.TOTAL 12 90g|CR DENT ORAL B ANTI|CR DENT ORAL B 123 7|CR DENTAL COLGATE TO|CR DENTAL COLGATE NA|CR DENT COLGATE NATU|CJ CR DENT COLGATE T|COLGATE MAXIMA PROTE|CR DENT COLGATE TOTA|CR DENT COLGATE TOTAL12 MINT 90G|CR.COLG.PROF.140G|CR.COLG.TOTAL WHITEN|KIT COLGATE TOTAL 2|KIT CR DENT COLGATE)', text: 'Pasta de Dentes'},
    ...
    {regex: '(QJO RALADO MESTRE CUCA 40G|QJO.RAL.PRESIDENT|QJO DINAPOLI 50G|QJO RALADO BIG 50G|QJO FUGINI 40G RALAD|QJO.RAL.VIGOR 50GR|QJO ITALAC 50G RALAD|QUEIJO PARMESAO RALADO ITALAC 50G|QUEIJO RALADO FIAPO TEIXEIRA 50G|QUEIJO RALADO TRAD TEIXEIRA 50G)', text: 'Queijo Ralado'},
    ...
    {regex: '(SARD 88 250G|SARDINHA PALMEIRA 12|SARDINHA ROBINSON CR|SARDINHA OLEO ROBINSON CRUSOE 125G|SARD.COQUEIRO 125G|SARDINHA EVISC CONG COSTA SUL 800G)', text: 'Sardinha'},
    ...
    {regex: '(TORRADA VISCONTI 120g. MULT|TORRADA VISCONTI 120)', text: 'Torrada'},
    ...
    {regex: '(VINAGRE PALADIO 750ml ALC COL|VINAG.BELMONT ALCOOL|VINAG.BELMONT MACA|VINAGRE ALCOOL NEVAL 750ML|VINAGRE CASTELO 750M|VINAGRE FORTALEZA 75)', text: 'Vinagre'},
