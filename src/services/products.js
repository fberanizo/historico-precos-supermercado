export const getProducts = () => {
  return [
    ...
    {regex: '(ACUCAR REF.CARAVELAS|ACUCAR MAIS DOCE 1KG|UNIAO 1KG REFINADO C|ACUCAR CRISTAL CARAVELAS 1KG|ACUCAR BIG BOM EXTRA|ACUCAR REF CARAVELAS 1KG|ACUCAR REF.CARAVELAS|ACUCAR A ALEGRE 1KG|ACUCAR CARAVELAS 1KG)', text: 'Açúcar Refinado 1kg'},
    {regex: '(ACUCAR MASCAVO LOWCU)', text: 'Açúcar Mascavo 300g'},
    {regex: '(ACUCAR UNIAO DEMERAR)', text: 'Açúcar Demerara 1kg'},
    {regex: '(ADOC.ZERO-CAL 200ML|ADOC LIQ ZERO CAL 100ML|ADOC.ZERO-CAL 100ML|ADOCANTE ZERO CAL LI|ADOC ZERO CAL SACARI)', text: 'Adoçante'},
    ...
    {regex: '(AMAC.R.BARBAREX 2L|AMAC URCA FLORAL 2L|AMAC FLEUR D YPE ACONCHEGO AZUL 2L|AMAC FLOR YPE LV 2L|AMAC.PLUSH 2L|AMAC.YPE AZUL PROMO|AMACIANTE YPE 2L)', text: 'Amaciante'},
    ...
    {regex: '(BACON SEARA KG|BACON MANTA SADIA KG|BACON MANTA SADIA KG|BACON SANTA ROSA PED|BACON SADIA)', text: 'Bacon'},
    ...
    {regex: '(B.BOM GAROTO 250G|BOMBOM NESTLE ESPECIALIDADES 300G|BOMBOM LACTA 289.2G|BOMBOM NESTLE 300G E|BOMBOM NESTLE ESPECIALIDADES 300G|BOMBOM GAROTO 250G S|BOMBOM GAROTO 300G S|BOMBOM LACTA 250 6G|BOMBOM NESTLE 251G E)', text: 'Caixa de Bombons'},
    ...
    {regex: '(CH.PO OETKER 200g|CHOCOLATE PO HIKARI)', text: 'Chocolate em pó'},
    ...
    {regex: '(CR.COLG.TOTAL 12 90g|CR DENT ORAL B ANTI|CR DENT ORAL B 123 7|CR DENTAL COLGATE TO|CR DENTAL COLGATE NA|CR DENT COLGATE NATU|CJ CR DENT COLGATE T|COLGATE MAXIMA PROTE|CR DENT COLGATE TOTA|CR DENT COLGATE TOTAL12 MINT 90G|CR.COLG.PROF.140G|CR.COLG.TOTAL WHITEN|KIT COLGATE TOTAL 2)', text: 'Pasta de Dentes'},
    ...
    {regex: '(CR.PENT.NIELY GOLD|CR PENTEAR PANTENE 2)', text: 'Creme de Pentear'},
    ...
    {regex: '(DET.LIQ.YPE COCO|DET.LIQ.YPE CLEAR|DET.LIQ.YPE 500ML|LIMP.LIMPOL 500ML|LAVA LOUCA MINUANO 5|DETERG LIQ SUPREMA FR VERMELHAS 500ML|DET.LIQ.MINUANO LIM.|DET.LIQ.MINUANO MACA|DET.LIQ.MINUANO MAR.|DET.LIQ.YPE PACK|DETERG LIQ SUPREMA FR VERMELHAS 500ML|DETERG LIQ SUPREMA LIMAO 500ML|DETERG LIQ SUPREMA NEUTRO 500ML|L LOUCA TRIEX 500ML)', text: 'Detergente'},
    ...
    {regex: '(ESC.TEK MED.|ESC DENT COLGATE ESSENCIAL CLEAN MACIA|ESC DENT J J REACH ULTRA CLEAN GRANDE|ESC DENT J J TEK|ESC.REACH.U.CLEAN MD|ESC DENT J J TEK DU|ESC DENT SORRISO TRI)', text: 'Escova de Dentes'},
    ...
    {regex: '(FAR.TRIGO RENATA 1KG|TRIGO NONITA 1KG|FAR.TRIGO T.OFELIA 1|FARINHA TRIGO RENATA|FARINHA CLARICE 1KG|FARINHA DE TRIGO LILI 1KG|FARINHA DE TRIGO SANTA CLARA 1KG|FARINHA TRIGO BIG BO)', text: 'Farinha de Trigo'},
    {regex: '(FAROFA MAND HIKARI 5|FAROFA MONJOLINHO|FAROFA PRONTA MAND YOKI 500G|FAROFA YOKI 500G)', text: 'Farofa'},
    {regex: '(FEIJAO C.OLIRON 1KG|FEIJAO DIVINO 1KG CA|FEIJAO CABRERA 2KG|FEIJAO CAIPIRA 2KG C|FEIJAO KIBELLO 1KG C|FEIJAO SOBRADINHO 1K|FEIJAO DU DE 1KG PRE|FEIJAO CAIPIRA 1KG C|FEIJAO CARIOCA DA CASA TP 1 1KG|FEIJAO CREMOSO 1KG C|FEIJAO CREMOSO 2KG C|FEIJAO G.CAMPO 1KG)', text: 'Feijão'},
    {regex: '(FEIJ.PRETO CAMIL 1KG|FEIJAO CABRERA PRETO)', text: 'Feijão Preto'},
    ...
    {regex: '(FUBA KISABOR 500G|FUBA HIKARI 500G MIM|FUBA KODILAR 500G|FUBA YOKI 1KG|FUBA YOKI 500G|FUBA SANJER 500G MIM|FUBA SANJER MIMOSO 5)', text: 'Fubá'},
    ...
    {regex: '(IOG.LIQ.PAULISTA 850G|IOG DANONE 1350G VIT|IOG DANONE ACTIVIA Z|IOG PAULISTA LIQ 850|IOG MORANGO DANONE 1350G|IOG DANONE ACTIVIA 1|BEBIDA LACTEA MORANGO PAULISTA 850G|LEITE FERM AMEIXA 0% ACTIVIA 1250G|IOG NESTLE 1250G MOR|IOG NESTLE 1250G VIT|BEB LACT PALISTA 850|BEB LACT PAULISTA 85)', text: 'Iogurte'},
    ...
    {regex: '(LEITE LIDER 1L|LEITE JUSSARA 1L TP|LEITE JUSSARA MAX PE|LEITE PIRACANJUBA 1L|LEITE DESN CT ITALAC 1L|LEITE DESN.JUSSARA|LEITE DESNATADO NILZA 1LT|LEITE L VIDA BLINK 1|LEITE L VIDA MATILA|LEITE L VIDA TIROL 1|LEITE LONGA VIDA DESN ITALAC CT 1L|LEITE LONGA VIDA DESNAT PIRACANJUBA 1L)', text: 'Leite'},
    ...
    {regex: '(LIMP.UAU LV.1L PG.800ML|LIMP UAU M USO 500ML|LIMP UAU MULTIUSO 50|LIMPADOR UAU MULTI U|LIMP ZAP CLEAN M USO LARANJA 500ML|LIMP UAU M USO 10 G|LIMP UAU MULTI USO LAVANDA 500ML|LIMP.M.USO.UAU LAV)', text: 'Limpador UAU'},
    ...
    {regex: '(LING.CAL.SADIA KG|LING SEARA CALABRESA|CALABRESA SANTA ROSA|LING.CAL.PERDIGAO KG|LINGUICA CALABRESA SADIA KG|CALABRESA PERDIGAO D)', text: 'Linguiça Calabresa'},
    ...
    {regex: '(MAIONESE ARISCO 500g|MAIONESE HELLMANNS 5|MAIONESE SUAVIT 500G|MAIONESE SUAVIT PT 500G)', text: 'Maionese'},
    ...
    {regex: '(MILHO FUGINI SACHET|MILHO FUGINI 200G SA|MILHO FUGINI SACHET|MILHO VERDE STELA DORO 200G)', text: 'Milho'},
    {regex: '(MOLHO TRAD.PRED.340g|MOLHO FUGINI SACHE 3|MOLHO TOM TRAD REFOG PREDILECTA SCH 340G|MOLHO TOM TRAD PRIMOR SACHE 340G|MOLHO TRAD.PRED.340g|MOLHO VAL SACHE 340G)', text: 'Molho de Tomate'},
    ...
    {regex: '(PAP.TOALHA YURI FIT|TOALHA PAPEL NATUREZ|TOALHA PAPEL YURI FI|TOALHA PAPEL SELECT 2UN|TOALHA PAPEL YURI 2|TOALHA YURI FIT C2)', text: 'Toalha Papel'},
