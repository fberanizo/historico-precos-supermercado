export const getProducts = () => {
  return [
    ...
    {regex: '(BACON SANTA ROSA PED|BACON SEARA KG|BACON MANTA SADIA KG|BACON MANTA SADIA KG|BACON SANTA ROSA PED|BACON SADIA)', text: 'Bacon'},
    ...
    {regex: '(LUSTRA MOV DESTAC 20|LUSTRA MOV BRAVO CLA|LUSTRA MOVEIS BRAVO|LIMP YPE M USO CLASSICO 500ML GTS 50ML|LUSTRA M.YPE JASMIM|LUSTRA MOVEIS YPE 20)', text: 'Lustra-Móveis'},
    ...
    {regex: '(CALABRESA SANTA ROSA|LING.CAL.SADIA KG|LING SEARA CALABRESA|CALABRESA SANTA ROSA|LING.CAL.PERDIGAO KG|LINGUICA CALABRESA SADIA KG|CALABRESA PERDIGAO D)', text: 'Linguiça Calabresa'},
    ...
    {regex: '(SH SEDA 325ML|SH SEDA LISO PERFEITO 325ML|SH SUAVE 325ML|SH.SUAVE 325ML|SHAMPOO F VEGETAIS|SHAMPOO FARMAERVAS)', text: 'Shampoo'},
    ...
    {regex: '(TOALHA PAPEL STYLUS|PAP.TOALHA YURI FIT|TOALHA PAPEL NATUREZ|TOALHA PAPEL YURI FI|TOALHA PAPEL SELECT 2UN|TOALHA PAPEL YURI 2|TOALHA YURI FIT C2)', text: 'Toalha Papel'},
