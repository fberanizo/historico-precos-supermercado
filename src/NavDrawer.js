      ...
      <Drawer dismissible={this.props.dismissible} open={this.props.open}>
        <DrawerContent>
          <List tag='nav' singleSelection selectedIndex={this.props.selectedIndex}>
            ...
            <ListItem onClick={this.props.onListItemClick} data-regex='(CAFE 3 COR.SACHET|CAFE 3 CORACOES SOLU|CAFE SOL.PACAEMBU|CAFE SOLUVEL PELE SCH 50G|MELITTA SOLUVEL 50G|CAFE PACAEMBU SOLUVE)'><ListItemText primaryText='Café Solúvel' /></ListItem>
            ...
            <ListItem onClick={this.props.onListItemClick} data-regex='(HIDRAT DAVENE LEITE|LEITE H.PAIXAO 200ML|HIDRAT DAVENE HIPOAL)'><ListItemText primaryText='Hidratante de Pele' /></ListItem>
            ...
            <ListItem onClick={this.props.onListItemClick} data-regex='(IOG DANONE ACTIVIA 1|BEBIDA LACTEA MORANGO PAULISTA 850G|LEITE FERM AMEIXA 0% ACTIVIA 1250G|IOG NESTLE 1250G MOR|IOG NESTLE 1250G VIT)'><ListItemText primaryText='Iogurte' /></ListItem>
            ...
            <ListItem onClick={this.props.onListItemClick} data-regex='(LEITE COCO MENINA 20|LEITE COCO TRAD.200M)'><ListItemText primaryText='Leite de Coco' /></ListItem>
