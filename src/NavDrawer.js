      ...
      <Drawer dismissible={this.props.dismissible} open={this.props.open}>
        <DrawerContent>
          <List tag='nav' singleSelection selectedIndex={this.props.selectedIndex}>
            ...
            <ListItem onClick={this.props.onListItemClick} data-regex='(ACUCAR CRISTAL CARAVELAS 1KG|ACUCAR BIG BOM EXTRA|ACUCAR REF CARAVELAS 1KG|ACUCAR REF.CARAVELAS)'><ListItemText primaryText='Açúcar Refinado 1kg' /></ListItem>
            ...
            <ListItem onClick={this.props.onListItemClick} data-regex='(AP BARB BIC COMFORT TWIN NORMAL 2UN|AP BARB PRESTOBARBA U GRIP 3 2UN|AP SUPER SHAVE 2UN|AP SUPER SHAVE 3 BAR)'><ListItemText primaryText='Aparelho de Barbear' /></ListItem>
            ...
            <ListItem onClick={this.props.onListItemClick} data-regex='(ARROZ PARBOILIZADO CAMIL 5KG|ARROZ PAN FERRO 5K P|ARROZ PARB.B.LEGAL|ARROZ PARB.RAROZ|ARROZ PARBOILIZADO CAMIL 5KG|ARROZ PARBOLIZADO BLUE VILLE 5KG|SOBRADINHO 5K PARBOI)'><ListItemText primaryText='Arroz 5kg' /></ListItem>
            ...
            <ListItem onClick={this.props.onListItemClick} data-regex='(AZEITE PURO GALLO VD 500ML|AZ.OLIV.CONDE 500ML|AZEITE COCINERO 500M|AZEITE EX VIRGEM FAMIGLIA DORO VD 500ML|AZEITE EX VIRGEM LA ESPANOLA VD 500ML)'><ListItemText primaryText='Azeite' /></ListItem>
            ...
            <ListItem onClick={this.props.onListItemClick} data-regex='(BACON MANTA SADIA KG|BACON MANTA SADIA KG|BACON SANTA ROSA PED)'><ListItemText primaryText='Bacon' /></ListItem>
            <ListItem onClick={this.props.onListItemClick} data-regex='(BECEL 250G|BECEL 500G|BECEL 500G MANTEIGA|CR VEGETAL PRIME 500|CR.VEG.BECEL 500G|CREME VEGETAL CSAL TRAD BECEL 500G|MARG CLAYBOM 500G)'><ListItemText primaryText='Margarina' /></ListItem>
            <ListItem onClick={this.props.onListItemClick} data-regex='(BISC AGUA E SAL SPECIALAT 400G|BISC AGUA E SAL TRIUNFO 375G|BISC.A.SAL ZABET 400)'><ListItemText primaryText='Bolacha Água e Sal' /></ListItem>
            ...
            <ListItem onClick={this.props.onListItemClick} data-regex='(BOMBOM NESTLE ESPECIALIDADES 300G|BOMBOM LACTA 289.2G|BOMBOM NESTLE 300G E|BOMBOM NESTLE ESPECIALIDADES 300G)'><ListItemText primaryText='Caixa de Bombons' /></ListItem>
            <ListItem onClick={this.props.onListItemClick} data-regex='(C SECA PAINEIRA 500G)'><ListItemText primaryText='Carne Seca' /></ListItem>
            <ListItem onClick={this.props.onListItemClick} data-regex='(CAFE ALMOF TRAD 3 CORACOES 500G|CAFE 3 COR.500g|CAFE 3 COR.PROMO|CAFE 3 CORACOES TRAD|CAFE ALMOF EXTRA FORTE BRASILEIRO 500G|CAFE BIGBOM 500G|CAFE VACUO EX FORTE MANHA 500G)'><ListItemText primaryText='Café 500g' /></ListItem>
            ...
            <ListItem onClick={this.props.onListItemClick} data-regex='(CALDO MAGGI CARNE 114G|CALDO KNORR 114GR|CALDO KNORR GALINHA|CALDO KNORR LV12PG10|CALDO MAGGI 152G)'><ListItemText primaryText='Caldo Knorr' /></ListItem>
            <ListItem onClick={this.props.onListItemClick} data-regex='(CANJICA MILHO YOKI 5)'><ListItemText primaryText='Canjica' /></ListItem>
            ...
            <ListItem onClick={this.props.onListItemClick} data-regex='(DESINF BUFALO FLORAL 2L|DESINF DETAX 2L|DESINF SANOL 2L LAV|DESINF SANOL LAVANDA 2L|DESINF URCA LAVANDA 2L|DESINF.SANOL FLOR.2L|DESINFETANTE BAK YPE|PINHO CANDURA VIOLET)'><ListItemText primaryText='Desinfetante 2L' /></ListItem>
            ...
            <ListItem onClick={this.props.onListItemClick} data-regex='(ESC DENT COLGATE ESSENCIAL CLEAN MACIA|ESC DENT J J REACH ULTRA CLEAN GRANDE|ESC DENT J J TEK|ESC.REACH.U.CLEAN MD)'><ListItemText primaryText='Escova de Dentes' /></ListItem>
            ...
            <ListItem onClick={this.props.onListItemClick} data-regex='(FEIJAO DU DE 1KG PRE|FEIJAO CAIPIRA 1KG C|FEIJAO CARIOCA DA CASA TP 1 1KG|FEIJAO CREMOSO 1KG C|FEIJAO CREMOSO 2KG C|FEIJAO G.CAMPO 1KG)'><ListItemText primaryText='Feijão' /></ListItem>
            ...
            <ListItem onClick={this.props.onListItemClick} data-regex='(IOG MORANGO DANONE 1350G|IOG DANONE ACTIVIA 1|BEBIDA LACTEA MORANGO PAULISTA 850G|LEITE FERM AMEIXA 0% ACTIVIA 1250G|IOG NESTLE 1250G MOR|IOG NESTLE 1250G VIT)'><ListItemText primaryText='Iogurte' /></ListItem>
            ...
            <ListItem onClick={this.props.onListItemClick} data-regex='(MAIZENA 200G)'><ListItemText primaryText='Maisena' /></ListItem>
            ...
            <ListItem onClick={this.props.onListItemClick} data-regex='(PANETTONE CHOC POLLI CASA DORO 400G|PANETTONE FRUTAS POLLI CASA DORO 400G|PANETTONE FRUTAS NO PONTO KG|PANETTONE G.B.1KG)'><ListItemText primaryText='Panetone' /></ListItem>
